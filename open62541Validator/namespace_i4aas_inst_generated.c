...
retVal |= UA_Server_addReference(server, UA_NODEID_NUMERIC(ns[2], 109LU), UA_NODEID_NUMERIC(ns[0], 46LU), UA_EXPANDEDNODEID_NUMERIC(ns[2], 108LU), false);
return retVal;
}
...
UA_NODEID_NUMERIC(ns[1], 1005LU),
(const UA_NodeAttributes*)&attr, &UA_TYPES[UA_TYPES_OBJECTATTRIBUTES],NULL, NULL);
retVal |= UA_Server_addReference(server, UA_NODEID_NUMERIC(ns[2], 121LU), UA_NODEID_NUMERIC(ns[0], 47LU), UA_EXPANDEDNODEID_NUMERIC(ns[2], 237LU), false);
return retVal;
}
