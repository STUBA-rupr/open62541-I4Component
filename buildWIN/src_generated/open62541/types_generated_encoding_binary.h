...
/* AliasNameDataType */
static UA_INLINE size_t
UA_AliasNameDataType_calcSizeBinary(const UA_AliasNameDataType *src) {
    return UA_calcSizeBinary(src, &UA_TYPES[UA_TYPES_ALIASNAMEDATATYPE]);
}
static UA_INLINE UA_StatusCode
UA_AliasNameDataType_encodeBinary(const UA_AliasNameDataType *src, UA_Byte **bufPos, const UA_Byte *bufEnd) {
    return UA_encodeBinary(src, &UA_TYPES[UA_TYPES_ALIASNAMEDATATYPE], bufPos, &bufEnd, NULL, NULL);
}
static UA_INLINE UA_StatusCode
UA_AliasNameDataType_decodeBinary(const UA_ByteString *src, size_t *offset, UA_AliasNameDataType *dst) {
    return UA_decodeBinary(src, offset, dst, &UA_TYPES[UA_TYPES_ALIASNAMEDATATYPE], NULL);
}
...
/* OpaqueNumericRange */
static UA_INLINE size_t
UA_OpaqueNumericRange_calcSizeBinary(const UA_OpaqueNumericRange *src) {
    return UA_calcSizeBinary(src, &UA_TYPES[UA_TYPES_OPAQUENUMERICRANGE]);
}
static UA_INLINE UA_StatusCode
UA_OpaqueNumericRange_encodeBinary(const UA_OpaqueNumericRange *src, UA_Byte **bufPos, const UA_Byte *bufEnd) {
    return UA_encodeBinary(src, &UA_TYPES[UA_TYPES_OPAQUENUMERICRANGE], bufPos, &bufEnd, NULL, NULL);
}
static UA_INLINE UA_StatusCode
UA_OpaqueNumericRange_decodeBinary(const UA_ByteString *src, size_t *offset, UA_OpaqueNumericRange *dst) {
    return UA_decodeBinary(src, offset, dst, &UA_TYPES[UA_TYPES_OPAQUENUMERICRANGE], NULL);
}
